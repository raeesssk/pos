...
var BFHCurrenciesList = {
  ...
  'AMD':{'label':'Armenian dram (AMD)','currencyflag':'','symbol':'դր'},
  'AOA':{'label':'Angolan kwanza (AOA)','currencyflag':'','symbol':'Kz'},
  'ARS':{'label':'Argentine peso (ARS)','currencyflag':'','symbol':'$'},
  'AUD':{'label':'Australian dollar (AUD)','currencyflag':'AUD','symbol':'$'},
  'AWG':{'label':'Aruban florin (AWG)','currencyflag':'','symbol':'ƒ'},
  'AZN':{'label':'Azerbaijani manat (AZN)','currencyflag':'','symbol':''},
  'BAM':{'label':'Bosnia and Herzegovina convertible mark (BAM)','currencyflag':'','symbol':'KM'},
  'BBD':{'label':'Barbadian dollar (BBD)','currencyflag':'','symbol':'$'},
  'BDT':{'label':'Bangladeshi taka (BDT)','currencyflag':'','symbol':'৳'},
  'BGN':{'label':'Bulgarian lev (BGN)','currencyflag':'','symbol':'лв'},
  'BHD':{'label':'Bahraini dinar (BHD)','currencyflag':'','symbol':'.د.ب'},
  'BIF':{'label':'Burundian franc (BIF)','currencyflag':'','symbol':'Fr'},
  'BMD':{'label':'Bermudian dollar (BMD)','currencyflag':'','symbol':'$'},
  'BND':{'label':'Brunei dollar (BND)','currencyflag':'','symbol':'$'},
  'BOB':{'label':'Bolivian boliviano (BOB)','currencyflag':'','symbol':'Bs'},
  'BRL':{'label':'Brazilian real (BRL)','currencyflag':'','symbol':'R$'},
  'BSD':{'label':'Bahamian dollar (BSD)','currencyflag':'','symbol':'$'},
  'BTN':{'label':'Bhutanese ngultrum (BTN)','currencyflag':'','symbol':'Nu'},
  'BWP':{'label':'Botswana pula (BWP)','currencyflag':'','symbol':'P'},
  'BYR':{'label':'Belarusian ruble (BYR)','currencyflag':'','symbol':'Br'},
  'BZD':{'label':'Belize dollar (BZD)','currencyflag':'','symbol':'$'},
  'CAD':{'label':'Canadian dollar (CAD)','currencyflag':'','symbol':'$'},
  'CDF':{'label':'Congolese franc (CDF)','currencyflag':'','symbol':'Fr'},
  'CHF':{'label':'Swiss franc (CHF)','currencyflag':'CHF','symbol':'Fr'},
  'CLP':{'label':'Chilean peso (CLP)','currencyflag':'','symbol':'$'},
  'CNY':{'label':'Chinese yuan (CNY)','currencyflag':'','symbol':'¥'},
  'COP':{'label':'Colombian peso (COP)','currencyflag':'','symbol':'$'},
  'CRC':{'label':'Costa Rican colón (CRC)','currencyflag':'','symbol':'₡'},
  'CUP':{'label':'Cuban convertible peso (CUP)','currencyflag':'','symbol':'$'},
  'CVE':{'label':'Cape Verdean escudo (CVE)','currencyflag':'','symbol':'$'},
  'CZK':{'label':'Czech koruna (CZK)','currencyflag':'','symbol':'Kč'},
  'DJF':{'label':'Djiboutian franc (DJF)','currencyflag':'','symbol':'Fr'},
  'DKK':{'label':'Danish krone (DKK)','currencyflag':'DKK','symbol':'kr'},
  'DOP':{'label':'Dominican peso (DOP)','currencyflag':'','symbol':'$'},
  'DZD':{'label':'Algerian dinar (DZD)','currencyflag':'','symbol':'د.ج'},
  'EGP':{'label':'Egyptian pound (EGP)','currencyflag':'','symbol':'ج.م'},
  'ERN':{'label':'Eritrean nakfa (ERN)','currencyflag':'','symbol':'Nfk'},
  'ETB':{'label':'Ethiopian birr (ETB)','currencyflag':'','symbol':'Br'},
  'EUR':{'label':'Euro (EUR)','currencyflag':'EUR','symbol':'€'},
  'FJD':{'label':'Fijian dollar (FJD)','currencyflag':'','symbol':'$'},
  'FKP':{'label':'Falkland Islands pound (FKP)','currencyflag':'','symbol':'£'},
  'GBP':{'label':'British pound (GBP)','currencyflag':'','symbol':'£'},
  'GEL':{'label':'Georgian lari (GEL)','currencyflag':'','symbol':'ლ'},
  'GHS':{'label':'Ghana cedi (GHS)','currencyflag':'','symbol':'₵'},
  'GMD':{'label':'Gambian dalasi (GMD)','currencyflag':'','symbol':'D'},
  'GNF':{'label':'Guinean franc (GNF)','currencyflag':'','symbol':'Fr'},
  'GTQ':{'label':'Guatemalan quetzal (GTQ)','currencyflag':'','symbol':'Q'},
  'GYD':{'label':'Guyanese dollar (GYD)','currencyflag':'','symbol':'$'},
  'HKD':{'label':'Hong Kong dollar (HKD)','currencyflag':'','symbol':'$'},
  'HNL':{'label':'Honduran lempira (HNL)','currencyflag':'','symbol':'L'},
  'HRK':{'label':'Croatian kuna (HRK)','currencyflag':'','symbol':'kn'},
  'HTG':{'label':'Haitian gourde (HTG)','currencyflag':'','symbol':'G'},
  'HUF':{'label':'Hungarian forint (HUF)','currencyflag':'','symbol':'Ft'},
  ...
  'JEP':{'label':'Jersey pound (JEP)','currencyflag':'','symbol':'£'},
  'JMD':{'label':'Jamaican dollar (JMD)','currencyflag':'','symbol':'$'},
  'JOD':{'label':'Jordanian dinar (JOD)','currencyflag':'','symbol':'د.ا'},
  'JPY':{'label':'Japanese yen (JPY)','currencyflag':'','symbol':'¥'},
  'KES':{'label':'Kenyan shilling (KES)','currencyflag':'','symbol':'Sh'},
  'KGS':{'label':'Kyrgyzstani som (KGS)','currencyflag':'','symbol':'лв'},
  'KHR':{'label':'Cambodian riel (KHR)','currencyflag':'','symbol':'៛'},
  'KMF':{'label':'Comorian franc (KMF)','currencyflag':'','symbol':'Fr'},
  'KPW':{'label':'North Korean won (KPW)','currencyflag':'','symbol':'₩'},
  'KRW':{'label':'South Korean won (KRW)','currencyflag':'','symbol':'₩'},
  'KWD':{'label':'Kuwaiti dinar (KWD)','currencyflag':'','symbol':'د.ك'},
  'KYD':{'label':'Cayman Islands dollar (KYD)','currencyflag':'','symbol':'$'},
  'KZT':{'label':'Kazakhstani tenge (KZT)','currencyflag':'','symbol':'₸'},
  'LAK':{'label':'Lao kip (LAK)','currencyflag':'','symbol':'₭'},
  'LBP':{'label':'Lebanese pound (LBP)','currencyflag':'','symbol':'ل.ل'},
  'LKR':{'label':'Sri Lankan rupee (LKR)','currencyflag':'','symbol':'Rs'},
  'LRD':{'label':'Liberian dollar (LRD)','currencyflag':'','symbol':'$'},
  'LSL':{'label':'Lesotho loti (LSL)','currencyflag':'','symbol':'L'},
  'LTL':{'label':'Lithuanian litas (LTL)','currencyflag':'','symbol':'Lt'},
  'LVL':{'label':'Latvian lats (LVL)','currencyflag':'','symbol':'Ls'},
  'LYD':{'label':'Libyan dinar (LYD)','currencyflag':'','symbol':'ل.د'},
  'MAD':{'label':'Moroccan dirham (MAD)','currencyflag':'','symbol':'د.م.'},
  'MDL':{'label':'Moldovan leu (MDL)','currencyflag':'','symbol':'L'},
  'MGA':{'label':'Malagasy ariary (MGA)','currencyflag':'','symbol':'Ar'},
  'MKD':{'label':'Macedonian denar (MKD)','currencyflag':'','symbol':'ден'},
  'MMK':{'label':'Burmese kyat (MMK)','currencyflag':'','symbol':'Ks'},
  'MNT':{'label':'Mongolian tögrög (MNT)','currencyflag':'','symbol':'₮'},
  'MOP':{'label':'Macanese pataca (MOP)','currencyflag':'','symbol':'P'},
  'MRO':{'label':'Mauritanian ouguiya (MRO)','currencyflag':'','symbol':'UM'},
  'MUR':{'label':'Mauritian rupee (MUR)','currencyflag':'','symbol':'Rs'},
  'MVR':{'label':'Maldivian rufiyaa (MVR)','currencyflag':'','symbol':'.ރ'},
  'MWK':{'label':'Malawian kwacha (MWK)','currencyflag':'','symbol':'MK'},
  'MXN':{'label':'Mexican peso (MXN)','currencyflag':'','symbol':'$'},
  'MYR':{'label':'Malaysian ringgit (MYR)','currencyflag':'','symbol':'MR'},
  'MZN':{'label':'Mozambican metical (MZN)','currencyflag':'','symbol':'MT'},
  'NAD':{'label':'Namibian dollar (NAD)','currencyflag':'','symbol':'$'},
  'NGN':{'label':'Nigerian naira (NAN)','currencyflag':'','symbol':'₦'},
  'NIO':{'label':'Nicaraguan córdoba (NIO)','currencyflag':'','symbol':'C$'},
  'NOK':{'label':'Norwegian krone (NOK)','currencyflag':'','symbol':'kr'},
  'NPR':{'label':'Nepalese rupee (NPR)','currencyflag':'','symbol':'Rs'},
  'NZD':{'label':'New Zealand dollar (NZD)','currencyflag':'','symbol':'$'},
  'OMR':{'label':'Omani rial (OMR)','currencyflag':'','symbol':'ر.ع.'},
  'PAB':{'label':'Panamanian balboa (PAB)','currencyflag':'','symbol':'B/.'},
  'PEN':{'label':'Peruvian nuevo sol (PEN)','currencyflag':'','symbol':'S/.'},
  'PGK':{'label':'Papua New Guinean kina (PGK)','currencyflag':'','symbol':'K'},
  'PHP':{'label':'Philippine peso (PHP)','currencyflag':'','symbol':'₱'},
  'PKR':{'label':'Pakistani rupee (PKR)','currencyflag':'','symbol':'Rs'},
  'PLN':{'label':'Polish złoty (PLN)','currencyflag':'','symbol':'zł'},
  'PRB':{'label':'Transnistrian ruble (PRB)','currencyflag':'','symbol':'р.'},
  'PYG':{'label':'Paraguayan guaraní (PYG)','currencyflag':'','symbol':'₲'},
  'QAR':{'label':'Qatari riyal (QAR)','currencyflag':'','symbol':'ر.ق'},
  'RON':{'label':'Romanian leu (RON)','currencyflag':'','symbol':'L'},
  'RSD':{'label':'Serbian dinar (RSD)','currencyflag':'','symbol':'дин'},
  'RUB':{'label':'Russian ruble (RUB)','currencyflag':'','symbol':'руб.'},
  'RWF':{'label':'Rwandan franc (RWF)','currencyflag':'','symbol':'Fr'},
  'SAR':{'label':'Saudi riyal (SAR)','currencyflag':'','symbol':'ر.س'},
  'SBD':{'label':'Solomon Islands dollar (SBD)','currencyflag':'','symbol':'$'},
  'SCR':{'label':'Seychellois rupee (SCR)','currencyflag':'','symbol':'Rs'},
  'SDG':{'label':'Singapore dollar (SDG)','currencyflag':'','symbol':'$'},
  'SEK':{'label':'Swedish krona (SEK)','currencyflag':'','symbol':'kr'},
  'SGD':{'label':'Singapore dollar (SGD)','currencyflag':'','symbol':'$'},
  'SHP':{'label':'Saint Helena pound (SHP)','currencyflag':'','symbol':'£'},
  'SLL':{'label':'Sierra Leonean leone (SLL)','currencyflag':'','symbol':'Le'},
  'SOS':{'label':'Somali shilling (SOS)','currencyflag':'','symbol':'Sh'},
  'SRD':{'label':'Surinamese dollar (SRD)','currencyflag':'','symbol':'$'},
  'SSP':{'label':'South Sudanese pound (SSP)','currencyflag':'','symbol':'£'},
  'STD':{'label':'São Tomé and Príncipe dobra (STD)','currencyflag':'','symbol':'Db'},
  'SVC':{'label':'Salvadoran colón (SVC)','currencyflag':'','symbol':'₡'},
  'SYP':{'label':'Syrian pound (SYP)','currencyflag':'','symbol':'£'},
  'SZL':{'label':'Swazi lilangeni (SZL)','currencyflag':'','symbol':'L'},
  'THB':{'label':'Thai baht (THB)','currencyflag':'','symbol':'฿'},
  'TJS':{'label':'Tajikistani somoni (TJS)','currencyflag':'','symbol':'SM'},
  'TMT':{'label':'Turkmenistan manat (TMT)','currencyflag':'','symbol':'m'},
  'TND':{'label':'Tunisian dinar (TND)','currencyflag':'','symbol':'د.ت'},
  'TOP':{'label':'Tongan paʻanga (TOP)','currencyflag':'','symbol':'T$'},
  'TRY':{'label':'Turkish lira (TRY)','currencyflag':'','symbol':'&#8378;'},
  'TTD':{'label':'Trinidad and Tobago dollar (TTD)','currencyflag':'','symbol':'$'},
  'TWD':{'label':'New Taiwan dollar (TWD)','currencyflag':'','symbol':'$'},
  'TZS':{'label':'Tanzanian shilling (TZS)','currencyflag':'','symbol':'Sh'},
  'UAH':{'label':'Ukrainian hryvnia (UAH)','currencyflag':'','symbol':'₴'},
  'UGX':{'label':'Ugandan shilling (UGX)','currencyflag':'','symbol':'Sh'},
  'USD':{'label':'United States dollar (USD)','currencyflag':'','symbol':'$'},
  'UYU':{'label':'Uruguayan peso (UYU)','currencyflag':'','symbol':'$'},
  'UZS':{'label':'Uzbekistani som (UZS)','currencyflag':'','symbol':'лв'},
  'VEF':{'label':'Venezuelan bolívar (VEF)','currencyflag':'','symbol':'Bs F'},
  'VND':{'label':'Vietnamese đồng (VND)','currencyflag':'','symbol':'₫'},
  'VUV':{'label':'Vanuatu vatu (VUV)','currencyflag':'','symbol':'Vt'},
  'WST':{'label':'Samoan tālā (WST)','currencyflag':'','symbol':'T'},
  'XAF':{'label':'Central African CFA franc (XAF)','currencyflag':'XAF','symbol':'Fr'},
  'XCD':{'label':'East Caribbean dollar (XCD)','currencyflag':'XCD','symbol':'$'},
  'XOF':{'label':'West African CFA franc (XOF)','currencyflag':'XOF','symbol':'Fr'},
  'XPF':{'label':'CFP franc','currencyflag (XPF)':'XPF','symbol':'Fr'},
  'YER':{'label':'Yemeni rial (YER)','currencyflag':'','symbol':'﷼'},
  'ZAR':{'label':'South African rand (ZAR)','currencyflag':'ZAR','symbol':'R'},
  'ZMW':{'label':'Zambian kwacha (ZMW)','currencyflag':'','symbol':'ZK'},
