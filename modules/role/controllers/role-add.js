...
angular.module('role').controller('roleAddCtrl', function ($rootScope, $http, $scope, $location, $routeParams, $route) {
    ...
    $scope.role.userid=localStorage.getItem('pos_userid');
  $scope.role.rm_srm_id = localStorage.getItem("pos_admin_srm_id");
    ...
    $scope.getPermission = function(){
        ...
        .success(function(obj)
        {
                ...
                obj.forEach(function(value, key){
                     $http({
                      method: 'GET',
                      url: $rootScope.baseURL+'/permission/view/'+value.pmm_id,
                      //data: $scope.data,
                      headers: {'Content-Type': 'application/json',
                              'Authorization' :'Bearer '+localStorage.getItem("pos_admin_access_token")}
                    })
